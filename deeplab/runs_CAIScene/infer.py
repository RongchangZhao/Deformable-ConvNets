...
parser.add_argument('--lst', type=str, default='./val.lst',
    help='')
parser.add_argument('--val-root-path', type=str, default='/raid5data/dplearn/aichallenger/scene/ai_challenger_scene_validation_20170908/scene_validation_images_20170908')
parser.add_argument('--test-root-path', type=str, default='/raid5data/dplearn/aichallenger/scene/ai_challenger_scene_test_a_20170922/scene_test_a_images_20170922')
